...
let satelite = L.tileLayer('http://{s}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}', {
  attribution: 'Map Data: Google ©2022',
  maxZoom: 18,
...
var mymap = L.map('mapcanvas', { layers: [calles, map] }).setView([-25.290800, -57.559465], 11);
